...
class _AdditionalSettingStepState extends ConsumerState<AdditionalSettingStep>
  ...
  void _validatePassword(String password) {
    setState(() {
      ...
      _progressAnimation = Tween<double>(
        begin: _progressAnimation.value, // 현재 값에서 시작
        end: progress,
      ).animate(
        CurvedAnimation(parent: _progressController, curve: Curves.easeInOut),
      );
  ...
  Future<void> _handleGmailConnection() async {
    ...
    setState(() {
      ...
      _isGmailConnected = true; // 바로 연동 완료 상태로 변경
    });
  }
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                //     color:
                //         _isGmailConnected
                //             ? const Color(0xFFF0FDF4) // 연한 초록색 배경
                //             : const Color(0xFFFFEBEB), // 연한 빨간색 배경
                //     borderRadius: BorderRadius.circular(8),
                //     border: Border.all(
                //       color:
                //           _isGmailConnected
                //               ? const Color(0xFF22C55E) // 초록색 테두리
                //               : const Color(0xFFDC2626), // 진한 빨강색으로 변경
                //       width: 1,
                //     ),
                //   ),
                //   child: Row(
      ...
      return SizedBox(
        ...
        child: ElevatedButton.icon(
          ...
          style: ElevatedButton.styleFrom(
            backgroundColor: const Color(0xFF4ADE80), // 더 연한 초록색으로 변경
            foregroundColor: Colors.white,
            padding: const EdgeInsets.symmetric(vertical: 12),
            shape: RoundedRectangleBorder(
              borderRadius: BorderRadius.circular(8),
            ),
            disabledBackgroundColor: const Color(0xFF4ADE80), // 비활성화 상태도 동일한 색상
